...
export function HomepageHeader() {
  ...
  // Read the documentation URL from the customFields on siteConfig.
  const documentationUrl = siteConfig.customFields?.documentationUrl || "http://kevin-docs.zebralock.ai/modules/usage/getting-started";
  return (
    <div className="homepage-header">
      <div className="header-content">
        ...
        <div align="center" className="header-links">
          ...
          <br/>
          <a href={documentationUrl}><img src="https://img.shields.io/badge/Documentation-000?logo=googledocs&logoColor=FFE165&style=for-the-badge" alt="Check out the documentation" /></a>
