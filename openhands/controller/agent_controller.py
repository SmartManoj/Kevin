...
from openhands.core.metrics import Metrics, TokenUsage
...
class AgentController:
    ...
    async def set_agent_state_to(self, new_state: AgentState) -> None:
        ...
        self.event_stream.add_event(
            AgentStateChangedObservation(f'From {old_state}', self.state.agent_state, reason),
    ...
    async def _step(self) -> None:
        ...
        step_log = f'LEVEL {self.state.delegate_level} LOCAL STEP {self.state.get_local_step()} GLOBAL STEP {self.state.iteration_flag.current_value}'
        self.log(
            'info',
            step_log,
            extra={'msg_type': 'STEP'},
